...
(8, '2024_10_03_121358_create_orders_table', 2),
(9, '2024_10_03_121452_create_order_details_table', 2);
...
INSERT INTO `orders` (`id`, `order_number`, `customer_name`, `customer_email`, `payment_status`, `created_at`, `updated_at`) VALUES
(1, 'PO202410050001', 'sasasasasa', 'sasaasasa', 1, '2024-10-05 06:13:10', '2024-10-05 06:13:47');
...
(1, 1, 1, 1, '2024-10-05 06:13:10', '2024-10-05 06:13:10'),
(2, 1, 6, 1, '2024-10-05 06:13:10', '2024-10-05 06:13:10'),
(3, 1, 9, 1, '2024-10-05 06:13:10', '2024-10-05 06:13:10');
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `level` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'customer'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
